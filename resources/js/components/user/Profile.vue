<template>
  <v-container fluid v-if="item">
    <v-row>
      <v-col cols="12" md="3" class="px-0" order-md="12">
        <v-card min-height="100%" class="mx-auto px-3" outlined>
          ...
          <v-row>
            <v-col class="d-flex justify-center">
                <v-icon class="mr-2" size="15" :color="item.active ? 'teal' : 'error'">mdi-checkbox-blank-circle</v-icon>
          ...
          <v-row>
            <v-col class="d-flex justify-center px-0">
              <v-row>
                <v-col cols="12" class="py-0 justify-center d-flex">Total Sales</v-col>
                <v-col cols="12" class="py-0 justify-center d-flex">$0</v-col>
              </v-row>
            </v-col>
            <v-col class="d-flex justify-center px-0">
              <v-row>
                <v-col cols="12" class="py-0 justify-center d-flex">Total Commission</v-col>
                <v-col cols="12" class="py-0 justify-center d-flex">$0</v-col>
              </v-row>
            </v-col>
          </v-row>
      ...
      <v-col cols="12" md="9" order-md="1">
        <v-tabs v-model="tab">
          <v-tab href="#downlines">Descendencia</v-tab>
...
export default {
  ...
  // watch:{loadingItem(val){alert(val)}},
  computed: {
